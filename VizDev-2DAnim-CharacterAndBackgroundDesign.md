# Colleen Sinclair
**Visual Development / 2D Artist • Character + Background Design**
...
## Summary
Visual development–focused illustrator and 2D artist with high-volume animation production experience creating production-ready characters, backgrounds, and style frames—plus frame-by-frame animation for a pilot. Strong in style consistency, clarity for downstream teams, and fast iteration under tight schedules.

## Core Skills
Visual development • Character design • Background design • Prop design  
Style frames • Style matching • Production-ready asset delivery  
2D animation (frame-by-frame) • Visual storytelling
...
**Jun 2022 – Aug 2022**
- Established visual styles for animated videos, ensuring brand consistency
...
### 2D Animator — Kinestry (Freelance)
**Mar 2022 – May 2022**
- Created animated GIFs based on existing illustrations
...
- Commissioned children’s book (8 spreads/16 pages + covers + spine): illustration + typography/layout; print-ready delivery
